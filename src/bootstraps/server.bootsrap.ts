...
import { configureGroupRoutes } from "modules/admin/group/presentation/group.routes";
import { configureCategoryRoutes } from "modules/admin/category/presentation/category.routes";
...
import { configureSkillRoutes } from "modules/admin/skill/presentation/skill.routes";
import { configureVendorProfileRoutes } from "@VendorProfile/presentation/vendor-profile.routes";
import { configureProformaRequestRoutes } from "modules/proformas/requests/presnetation/proforma-requests.routes";
import { configureProformaResponseRoutes } from "modules/proformas/response/presentation/proforma-reponse.routes";
import { configureSuggestionRoutes } from "modules/admin/suggestion/presentation/suggestion.routes";
...
import { configureCityRouter } from "modules/admin/city/presentation/city.routes";
