...
import { ICreateSkillUseCase } from "modules/admin/skill/application/use-case/create-skill/create-skill.use-case";
import { HttpResponse } from "@Common/response/http.response";
import { ReqCreateSkillDto } from "modules/admin/skill/application/use-case/create-skill/create-skill.dto";
import { inject, injectable } from "inversify";
import { SKILL_SYMBOLS } from "../infraestructure/container/skill.symbols";
import { IGetSkillsByCategoryIdUseCase } from "modules/admin/skill/application/use-case/get-skills-by-categoryId/get-skills-by-categoryId.use-case";
import { GetSkillsByCategoryIdRequest } from "modules/admin/skill/application/use-case/get-skills-by-categoryId/get-skills-by-categoryId.dto";
@injectable()
