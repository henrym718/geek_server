...
export function configureProformaRequestRoutes(): Router {
    ...
    proformarequestRoutes.get(
        "/vendor/:profileid",
        authenticate,
        checkRoles(RoleEnum.VENDOR),
        proformaRequestController.getAllByVendorProfile
    );
    proformarequestRoutes.get("/:skill", proformaRequestController.getProformaRequestBySkill);
